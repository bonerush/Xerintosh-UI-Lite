...
static void draw_terminal(void)
{
    ...
    int16_t term_h = HAL_SCREEN_HEIGHT - term_y - HAL_MARGIN_SM;
    ...
    hal_draw_rect(0, term_y, HAL_SCREEN_WIDTH, term_h, COLOR_FG);

    int16_t max_line_width = HAL_SCREEN_WIDTH - HAL_MARGIN_MD * 2;
