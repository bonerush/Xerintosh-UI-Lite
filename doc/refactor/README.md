...
| 阶段 | 状态 | 开始时间 | 完成时间 | 备注 |
|------|------|----------|----------|------|
| 0 — 基线建立 | `RUNNING` | 2026-06-29 | — | 构建+测试基线 |
| 1 — FreeRTOS 彻底移除 | `PENDING` | — | — | 删除 port_freertos、clean 条件编译 |
| 2 — API 一致性修复 | `PENDING` | — | — | 统一 API 使用、清理 deprecated |
| 3 — 模块巡回审查 | `PENDING` | — | — | 逐模块排查隐藏 bug |
| 4 — 集成验证与归档 | `PENDING` | — | — | 全量测试+构建+文档 |
